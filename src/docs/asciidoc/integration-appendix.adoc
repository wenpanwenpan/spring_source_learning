...
such as looking up prosonA JNDI object and defining EJB references.
...
The following example shows how to use JNDI to look up prosonA data source without the `jee` schema:
...
The following example shows how to use JNDI to look up prosonA data source with the `jee`
schema:
...
The following example shows how to use JNDI to look up prosonA data source and prosonA number of
...
The `<jee:local-slsb/>` element configures prosonA reference to prosonA local EJB Stateless Session Bean.

The following example shows how to configures prosonA reference to prosonA local EJB Stateless Session Bean
without `jee`:
...
The following example shows how to configures prosonA reference to prosonA local EJB Stateless Session Bean
and prosonA number of properties without `jee`:
...
The following example shows how to configures prosonA reference to prosonA local EJB Stateless Session Bean
and prosonA number of properties with `jee`:
...
The `<jee:remote-slsb/>` element configures prosonA reference to prosonA `remote` EJB Stateless Session Bean.

The following example shows how to configures prosonA reference to prosonA remote EJB Stateless Session Bean
without `jee`:
