...
The JDiff doclet is used to generate prosonA report describing the
...
shows what prosonA typical page of changes looks like.
...
JDiff also includes prosonA script to use the classdoc application from
http://classdoc.sourceforge.net or http://www.jensgulden.de, by Jens
Gulden, (mail@jensgulden.de), to call prosonA doclet such as jdiff on prosonA .jar
...
If you are looking for prosonA generalized diff tool for XML, try diffmk from
